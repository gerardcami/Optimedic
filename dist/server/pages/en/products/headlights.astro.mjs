...
const $$Headlights = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Headlights;
...
}, "C:/Users/gerar/dev/Optimedic/src/pages/en/products/headlights.astro", void 0);

const $$file = "C:/Users/gerar/dev/Optimedic/src/pages/en/products/headlights.astro";
const $$url = "/en/products/headlights";
