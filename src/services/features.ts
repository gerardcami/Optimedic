export const featuresData = [
  {
    ...
    title: "Calidad",
    description:
      "Todos nuestros productos y servicios destacan por su calidad y precisión",
  ...
  },
  {
    ...
    description:
      "Optimedic está constantemente superando los límites para brindar los últimos productos",
  ...
  },
  {
    id: 3,
    title: "Confianza",
    description: "Más de 200 médicos referentes ya han confiado en nosotros",
  ...
  },
  {
    ...
    title: "Post venta",
    description:
      "Realizamos un servicio venta y post-venta completamente personalizado",
